...
The actual code is located in the Wolfgang.DbContextBuilder-Core project.
This project is contained in a separate folder so that when it is built it doesn't cause conflicting package restores.
This project is only needed to build the NuGet package for Entity Framework 10.
